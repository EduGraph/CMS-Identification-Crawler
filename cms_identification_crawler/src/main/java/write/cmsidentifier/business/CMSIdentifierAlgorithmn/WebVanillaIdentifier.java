...
public class WebVanillaIdentifier implements ICMSIdentifier {
	private Site site;
		
	public WebVanillaIdentifier(Site site) {
		this.site = site;
	}
	...
	private boolean isMetaGeneratorTagFound() {
		...
		return metaContent != null && metaContent.contains("webVanilla");
	}
