...
public class WeblicationIdentifier implements ICMSIdentifier {
	private Site site;
		
	public WeblicationIdentifier(Site site) {
		this.site = site;
	}
	...
	private boolean isMetaGeneratorTagFound() {
		...
		return metaContent != null && metaContent.contains("Weblication");
	}
