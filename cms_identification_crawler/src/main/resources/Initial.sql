...
CREATE TABLE `cmsidentifier_write`.`Hochschule` ( `ID` INT NOT NULL AUTO_INCREMENT , `Name` VARCHAR(250) NOT NULL , `Website_URL` VARCHAR(250) NULL , `Wikipedia_URL` VARCHAR(250) NULL , `Semester_ID` INT NOT NULL , PRIMARY KEY (`ID`), INDEX (`Semester_ID`)) ENGINE = InnoDB;
