...
import write.cmsidentifier.business.CMSIdentifierAlgorithmn.Typo3Identifier;
...
public class Typo3IdentifierTest {
	...
	@Test
	public void ShouldReturnTypo3WhenTypo3IsFoundInClass(){
		// Arrange
		String html = "<div class=\"typo3\">";
		ICMSIdentifier typo3 = new Typo3Identifier(new Site(html, null));
